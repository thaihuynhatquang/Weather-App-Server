...
module.exports = {
    route: function (app) {
        ...
        app.get('/weather/postcast5day/lat=:lat/lon=:lon',(req,res)=>weather_route.send_fiveday_weather_by_location(req,res));  //ok
        app.get('/weather/postcast5day/:cityName',(req,res)=>weather_route.send_fiveday_weather_by_cityName(req,res));  //ok
